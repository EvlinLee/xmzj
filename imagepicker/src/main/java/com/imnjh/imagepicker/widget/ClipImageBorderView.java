...
public class ClipImageBorderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(cropHeight != 0){
            cropVPadding = (getHeight() - cropHeight) / 2;
        }
        ...
        if (cropHeight == 0) {
            ...
            canvas.drawRect(horizontalPadding, 0, getWidth() - horizontalPadding, cropVPadding, paint);
            canvas.drawRect(horizontalPadding, getHeight() - cropVPadding, getWidth() - horizontalPadding, getHeight(), paint);
        }
        ...
        if (cropHeight == 0) {
            ...
            canvas.drawRect(horizontalPadding, cropVPadding, getWidth() - horizontalPadding, getHeight() - cropVPadding, paint);
        }
    }
