...
public class CropImageActivity extends BasePickerActivity {
  ...
  private void init() {
    ...
    cropHeight = getIntent().getIntExtra(PhotoPickerActivity.PARAM_CROP_HEIGHT,-1);

    if(cropHeight > 0){
      clipImageLayout.setCropHeight(cropHeight);
    }
