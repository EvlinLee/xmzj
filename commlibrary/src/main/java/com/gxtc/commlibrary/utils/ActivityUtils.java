...
public final class ActivityUtils {
     ...
     * @param cls activity类
     */
    public static void startActivity(@NonNull final Class<?> cls, @NonNull final Context context) {
     ...
     */
    public static String getLauncherActivity(@NonNull final String packageName,Context context) {
