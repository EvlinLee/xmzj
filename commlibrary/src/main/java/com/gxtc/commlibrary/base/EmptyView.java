...
public class EmptyView {
    ...
    public void showEmptyView(int imageRes, String text, View.OnClickListener listener) {
        emptyTextView.setText(text);
        emptyImageView.setImageResource(imageRes);
        emptyImageView.setVisibility(View.VISIBLE);
        emptyTextView.setOnClickListener(listener);
        emptyImageView.setOnClickListener(listener);
        showEmptyView();
    }
