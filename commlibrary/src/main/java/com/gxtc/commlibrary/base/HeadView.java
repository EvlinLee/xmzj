...
public class HeadView {
    ...
    public HeadView(View view) {
        headCancelButton = (Button) view.findViewById(R.id.headCancelButton);
        headBackButton = (ImageButton) view.findViewById(R.id.headBackButton);
        headTitle = (TextView) view.findViewById(R.id.headTitle);
        headRightButton = (Button) view.findViewById(R.id.headRightButton);
        HeadRightImageButton = (ImageButton) view.findViewById(R.id.HeadRightImageButton);
        headArea = (RelativeLayout) view.findViewById(R.id.headArea);
        headLine = view.findViewById(R.id.head_line);
        headRightLayout = (LinearLayout) view.findViewById(R.id.headRightLinearLayout);
    }
    ...
    public HeadView showBackButton(View.OnClickListener listener) {
    ...
    public RelativeLayout getParentView(){ return headArea ;}
