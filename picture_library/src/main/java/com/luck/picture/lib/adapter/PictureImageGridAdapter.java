...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PictureImageGridAdapter(Context context, boolean isGif, boolean showCamera,
                                   ...
                                   boolean enablePreviewVideo, int cb_drawable,
                                   boolean is_checked_num, int type, boolean clickVideo,
                                   SoundPool soundPool, int soundID) {
        ...
        if (selectImages.size() >= maxSelectNum && !isChecked) {
            switch (type) {
                case FunctionConfig.TYPE_IMAGE:
                    Toast.makeText(context, String.format(context.getString(R.string.picture_message_max_num), maxSelectNum), Toast.LENGTH_LONG).show();
                    break;
                case FunctionConfig.TYPE_VIDEO:
                    Toast.makeText(context, String.format(context.getString(R.string.picture_message_video_max_num), maxSelectNum), Toast.LENGTH_LONG).show();
                    break;
                default:
                    break;
            }
