...
public class PicturePreviewActivity extends PictureBaseActivity implements View.OnClickListener, Animation.AnimationListener {
        ...
        ll_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectImages.size() >= maxSelectNum && isChecked) {
                    Toast.makeText(PicturePreviewActivity.this, String.format(getString(R.string.picture_message_max_num), maxSelectNum), Toast.LENGTH_LONG).show();
                    check.setSelected(false);
                    return;
                }
    ...
    public class SimpleFragmentAdapter extends FragmentPagerAdapter {
        ...
        public SimpleFragmentAdapter(FragmentManager fm) {
            ...
            for(LocalMedia media: images){
                fragments.add(PictureImagePreviewFragment.getInstance(media.getPath(), true, "", selectImages));
            }
        }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.picture_left_back) {
            ...
            PictureEditActivity.startActivit(this, images.get(viewPager.getCurrentItem()).getPath());
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == PictureEditActivity.REQUEST_CODE && resultCode == RESULT_OK && data != null){
            ...
            String currPath = images.get(viewPager.getCurrentItem()).getPath();
            for(LocalMedia media: selectImages){
                if(media.getPath().equals(currPath)){
                    media.setPath(path);
                }
            }
            ...
            adapter.fragments.get(viewPager.getCurrentItem()).onActivityResult(requestCode, resultCode, data);
            ImagesObservable.getInstance().notifySelectLocalMediaObserver(selectImages);
            EventEntity obj = new EventEntity(FunctionConfig.UPDATE_FLAG);
            obj.medias = selectImages;
            RxBus.getDefault().post(obj);
        }
    }
