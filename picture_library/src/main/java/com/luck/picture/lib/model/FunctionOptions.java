...
public class FunctionOptions implements Serializable {
    ...
    //裁剪相关   裁剪模式仅在单选模式基础上生效
    private boolean isCrop = false;     //是否裁剪
    private int maxWidth = -1;          //裁剪的最大尺寸
    private int maxHeight = -1;
    private int scaleW = 0;             //裁剪图片默认长宽比
    ...
    public int getPreviewColor() {
        if (previewColor == 0) {
            previewColor = Color.parseColor("#2b8cff");
        }
        return previewColor;
    }
    ...
    public int getCompleteColor() {
        if (completeColor == 0) {
            completeColor = Color.parseColor("#2b8cff");
        }
    ...
    public static class Builder {
        ...
        //设置裁剪图片默认宽高比例
        public Builder setAspectRatio(int scaleW, int scaleH) {
            options.setScaleW(scaleW);
            options.setScaleH(scaleH);
            return this;
        }
        ...
        public Builder setEnableSource(boolean isEnableSource) {
            options.setEnableSource(isEnableSource);
            return this;
        }
        ...
        public Builder setIsCrop(boolean isCrop){
