...
public class MyActionSheetDialog extends BottomBaseDialog<MyActionSheetDialog> {
    ...
    private int mCancelTextMarginBottom = 7;
    private int mCancelTextMarginTop = 0;
    private SparseArray<Integer> mMoreTextColoeArray;
    /** adapter(自定义适配器) */
    ...
    public View onCreateView() {
        ...
        line.setBackgroundColor(Color.parseColor("#D7D7D9"));
        LayoutParams lineLp = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        lineLp.height = dp2px(mDividerHeight);
        line.setLayoutParams(lineLp);
        ll_container.addView(line);

        /** mCancel btn */
        mTvCancel = new TextView(mContext);
        mTvCancel.setGravity(Gravity.CENTER);
        LayoutParams lp = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        lp.topMargin = dp2px(mCancelTextMarginTop);
        lp.bottomMargin = dp2px(mCancelTextMarginBottom);
    ...
    /** set item textcolor(item字体颜色)* @return MyActionSheetDialog */
    ...
    /**
     * 对单个item text设置颜色
     * @param moreTextColoeArray
     * @return
     */
    public MyActionSheetDialog moreTextColor(SparseArray<Integer> moreTextColoeArray){
        this.mMoreTextColoeArray=moreTextColoeArray;
        return this;
    }
    ...
    public MyActionSheetDialog cancelMarginBottom(int margindp){
        mCancelTextMarginBottom=margindp;
        return this;
    }
    public MyActionSheetDialog cancelMarginTop(int margindp){
        mCancelTextMarginTop=margindp;
        return this;
    }
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (mMoreTextColoeArray!=null&&mMoreTextColoeArray.get(position)!=null){
                tvItem.setTextColor(getContext().getResources().getColor(mMoreTextColoeArray.get(position)));
                Log.d("CircleMemberActivity", "" + mMoreTextColoeArray.get(position));
            }else{
