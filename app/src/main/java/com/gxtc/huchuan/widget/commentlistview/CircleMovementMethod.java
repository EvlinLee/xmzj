...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = MyApplication.getInstance().getApplicationContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MyApplication.getInstance().getApplicationContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
