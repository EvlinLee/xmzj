...
public class MPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabLeftRightMargin = 0;
    private int tabTopBottomMargin = 0;
    ...
    public MPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabLeftRightMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, tabLeftRightMargin, dm);
        tabTopBottomMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, tabTopBottomMargin, dm);
        ...
        tabLeftRightMargin = a.getDimensionPixelSize(R.styleable.MPagerSlidingTabStrip_pstsTabMarginLeftRight, tabLeftRightMargin);
        tabTopBottomMargin = a.getDimensionPixelSize(R.styleable.MPagerSlidingTabStrip_pstsTabMarginTopBottom, tabTopBottomMargin);
    ...
    private void addTab(final int position, View tab) {
        ...
        if(shouldExpand) {
            expandedTabLayoutParams.setMargins(tabLeftRightMargin, tabTopBottomMargin, tabLeftRightMargin, tabTopBottomMargin);
        }else{
            defaultTabLayoutParams.setMargins(tabLeftRightMargin, tabTopBottomMargin, tabLeftRightMargin, tabTopBottomMargin);
        }
