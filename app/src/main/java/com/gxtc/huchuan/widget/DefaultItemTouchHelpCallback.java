...
public class DefaultItemTouchHelpCallback extends ItemTouchHelper.Callback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (onItemTouchCallbackListener != null && viewHolder != null) {
            onItemTouchCallbackListener.onSelected(viewHolder.getAdapterPosition());
        }
    }
    ...
    public interface OnItemTouchCallbackListener {
        ...
        boolean onSelected(int adapterPosition);
    }
}
