...
public class PraiseTextView extends android.support.v7.widget.AppCompatTextView {
     ...
     * 第一个显示的图标
     */
    private int mIcon = R.drawable.circle_friend_comment_icon_zan_select;
    /**
    ...
    private SpannableStringBuilder getPraiseString () {
        ...
        iconimage miconimage = new iconimage (drawable);
        WeakReference<iconimage> weakReference = new WeakReference<iconimage>(miconimage);
        if(weakReference.get() == null) return null;
        mBuilder.setSpan(weakReference.get(), 0, 1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        mBuilder.append(" ");
    ...
    public static class PraiseInfo {
        ...
        public PraiseInfo setUserCode(String userCode) {
