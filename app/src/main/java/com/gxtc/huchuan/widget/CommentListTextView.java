...
public class CommentListTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public static  class CommentInfo {
        ...
        public String getNickUserCode() {
            return nickUserCode;
        }

        public CommentInfo setNickUserCode(String nickUserCode) {
            this.nickUserCode = nickUserCode;
            return this;
        }

        public String getTonickUserCode() {
            return tonickUserCode;
        }

        public CommentInfo setTonickUserCode(String tonickUserCode) {
            this.tonickUserCode = tonickUserCode;
            return this;
        }
        ...
        private String nickUserCode;
        private String tonickUserCode;
