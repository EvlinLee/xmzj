...
public class CommentListView extends LinearLayout {
    ...
    private List<CircleCommentBean> mDatas;
    ...
    public void setOnNameTextClickListener(OnNameTextClickListener onNameTextClickListener) {
        mOnNameTextClickListener = onNameTextClickListener;
    }
    ...
    public void setDatas(List<CircleCommentBean> datas) {
        if (datas == null) {
            datas = new ArrayList<>();
        }
        mDatas = datas;
    ...
    public List<CircleCommentBean> getDatas() {
        return mDatas;
    }
    ...
    private View getView(final int position) {
        ...
        final TextView commentTv = (TextView) convertView.findViewById(R.id.commentTv);
        final CircleMovementMethod circleMovementMethod = new CircleMovementMethod(itemSelectorColor, itemSelectorColor);

        final CircleCommentBean bean = mDatas.get(position);
        String name = bean.getUserName();
        String id = "" + bean.getId();
        String toReplyName = bean.getTargetUserName();
//        if (bean.getToReplyUser() != null) {
//            toReplyName = bean.getToReplyUser().getName();
//        }

        SpannableStringBuilder builder = new SpannableStringBuilder();
        builder.append(setClickableSpan(name, bean.getUserCode()));

        if (!TextUtils.isEmpty(toReplyName)) {

            builder.append(" 回复 ");
            builder.append(setClickableSpan(toReplyName, bean.getTargetUserCode()));
        }
        builder.append(": ");
        //转换表情字符
        String contentBodyStr = bean.getContent();
        //builder.append(UrlUtils.formatUrlString(contentBodyStr));
        builder.append(AndroidEmoji.ensure(contentBodyStr));
        ...
        commentTv.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (circleMovementMethod.isPassToTv()) {
                    ...
                    commentTv.setBackgroundColor(getResources().getColor(R.color.transparent));
                    return true;
                }
                return false;
            }
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor) {
                                    ...
                                    public void onClick(View widget) {
                                        mOnNameTextClickListener.onTextClick(textStr, id);
                                    }
    ...
    public interface OnNameTextClickListener {
        void onTextClick(String name, String id);
    }
