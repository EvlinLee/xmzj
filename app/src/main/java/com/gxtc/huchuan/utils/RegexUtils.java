...
public class RegexUtils {
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isQQ(CharSequence input){return isMatch(REGEX_QQ,input);};
    /**
     * 验证身份证号码15位
     *
     * @param input 待验证文本
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isCarId(CharSequence input) {
        return isMatch(REGEX_CARID, input);
    }
    ...
    public static boolean isLicensePlate(CharSequence input){
        return isMatch(REGEX_LICENSE_PLATE,input);
    }
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isMathPsw(CharSequence input) {
        return isMatch(REGEX_PSW, input);
    }
