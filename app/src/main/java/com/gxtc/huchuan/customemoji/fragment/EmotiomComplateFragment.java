...
import com.gxtc.huchuan.customemoji.adapter.EmotionPagerAdapter;
import com.gxtc.huchuan.customemoji.emotionkeyboardview.EmojiIndicatorView;
import com.gxtc.huchuan.customemoji.utils.DisplayUtils;
...
public class EmotiomComplateFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        // 遍历所有的表情的key
        for (Object emojiName : EmotionUtils.getEmojiMap(emotion_map_type).keySet()) {
            emotionNames.add((Integer) emojiName);
