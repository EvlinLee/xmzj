 ...
 */
@ProviderTag(messageContent = BlacklistMessage.class, showReadState = true)
public class BlacklistMessageProvider extends IContainerItemProvider.MessageProvider<CountDownMessage> {
