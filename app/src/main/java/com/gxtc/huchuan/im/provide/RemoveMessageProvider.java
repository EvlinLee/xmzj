 ...
 */
@ProviderTag(messageContent = RemoveMessage.class, showReadState = true)
public class RemoveMessageProvider extends IContainerItemProvider.MessageProvider<CountDownMessage> {
