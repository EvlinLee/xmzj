 ...
 */
@ProviderTag(messageContent = SilentMessage.class, showReadState = true)
public class SilentMessageProvider extends IContainerItemProvider.MessageProvider<CountDownMessage> {
