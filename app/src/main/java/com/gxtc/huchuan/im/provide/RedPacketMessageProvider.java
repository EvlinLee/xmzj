...
public class RedPacketMessageProvider extends IContainerItemProvider.MessageProvider<CountDownMessage> {
    ...
    public View newView(Context context, ViewGroup viewGroup) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_chat_red_packet, null);
