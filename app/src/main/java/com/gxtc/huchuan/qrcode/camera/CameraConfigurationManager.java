...
package com.gxtc.huchuan.qrcode.camera;
...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        mCameraResolution = findCloselySize(WindowUtil.getScreenWidth(MyApplication.getInstance()), WindowUtil.getScreenH(MyApplication.getInstance()),
                parameters.getSupportedPreviewSizes());
        Log.e(TAG, "Setting preview size: " + mCameraResolution.width + "-" + mCameraResolution.height);
        mPictureResolution = findCloselySize(WindowUtil.getScreenWidth(MyApplication.getInstance()), WindowUtil.getScreenH(MyApplication.getInstance()),
