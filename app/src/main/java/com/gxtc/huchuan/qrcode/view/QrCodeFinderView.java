...
package com.gxtc.huchuan.qrcode.view;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mFrameRect.left = (WindowUtil.getScreenW(context) - layoutParams.width) / 2;
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        mPaint.setTextSize(getResources().getDimension(R.dimen.textSize_s));
        ...
        float left = (WindowUtil.getScreenW(getContext()) - mPaint.getTextSize() * text.length()) / 2;
