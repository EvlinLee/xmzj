...
public class HomePageChatInfo {

    /**
     * chatInfoCount : 0
     * chatRoom : 2
     * chatRoomHeadPic : http://xmzjvip.b0.upaiyun.com/xmzj/1490343088914
     * chatRoomName : 一号
     * chatSeries : 0
     * chatSeriesCount : 0
     * chatTypeSonId : 0
    ...
    public List<?> getShareUsers() {
        return shareUsers;
    }

    public void setShareUsers(List<?> shareUsers) {
        this.shareUsers = shareUsers;
    }

    public List<?> getSignupUsers() {
        return signupUsers;
    }

    public void setSignupUsers(List<?> signupUsers) {
