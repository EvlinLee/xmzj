...
public class CircleFileAuditedAdapter extends BaseRecyclerAdapter<CircleFileBean> {
...
/*    id	文件ID
    ...
    public CircleFileAuditedAdapter(Context context, List<CircleFileBean> list, int itemLayoutId,
