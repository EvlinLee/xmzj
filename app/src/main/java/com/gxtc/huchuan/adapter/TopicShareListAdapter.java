...
public class TopicShareListAdapter extends BaseRecyclerAdapter<TopicShareListBean.DatasBean> {
    private final String countStr = "推荐了<font color=\"#0ab70e\">%s</font>个朋友过来听课";


    public TopicShareListAdapter(Context context, List<TopicShareListBean.DatasBean> list, int itemLayoutId) {
