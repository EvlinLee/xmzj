...
import com.gxtc.huchuan.ui.circle.classroom.classroomaudit.ClassRoomAuditFragment;
import com.gxtc.huchuan.ui.circle.classroom.classroomaudit.ClassRoomAuditedFragment;
...
public class NewClassRoomAuditActivity extends BaseTitleActivity implements View.OnClickListener {
    ...
    private NewClassRoomAuditedFragment mClassRoomAuditedFragment;
    private NewClassRoomAuditFragment   mClassRoomAuditFragment;
    ...
    private void initFragment() {
        mFragments.clear();
        mClassRoomAuditedFragment = new NewClassRoomAuditedFragment();
        ...
        mClassRoomAuditFragment = new NewClassRoomAuditFragment();
    ...
    public void upDateAuditedClassRoom() {
        if (mClassRoomAuditedFragment != null) {
            mClassRoomAuditedFragment.getDatas(true);
        }
    }

    public static void startActivity(Context context, int circcleId, String userCode) {
        Intent intent = new Intent(context, NewClassRoomAuditActivity.class);
