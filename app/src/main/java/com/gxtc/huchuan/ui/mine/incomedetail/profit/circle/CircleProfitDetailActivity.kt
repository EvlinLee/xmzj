 ...
 */
class CircleProfitDetailActivity : BaseTitleActivity(), InComeContract.View {
    var id:String? = null
    ...
    override fun initView() {
        ...
        type = bean?.type
        title = bean?.title
        baseHeadView.showTitle("圈子收益详细信息").showBackButton{
            finish()
        }
    ...
    override fun initData() {
        ...
        map?.put("dateType",dateType.toString())//0：本日，1：本周，2：本月，3:本年，4：全部
    ...
    companion object{
        ...
        fun jumpToIncomeInfoActivity(activity: Activity, bean: DistributionBean,dateType:Int){
            val intent = Intent(activity, CircleProfitDetailActivity::class.java)
