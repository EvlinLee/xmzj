...
import com.gxtc.huchuan.adapter.RecentAddAdapter
 ...
 * 新增用户
 */
class NewAddFragment: BaseTitleFragment() {

    private var start = 0
    private var dateType = "0"       //2 最近30天
    private var checkType = "0"      //0 新增用户 1 新增动态 2 活跃量
    private var groupId: Int ?= null

    private lateinit var mData: CircleSource
    private lateinit var mAdapter: RecentAddAdapter
    ...
    override fun initView(inflater: LayoutInflater?, container: ViewGroup?): View {
        ...
        mAdapter = RecentAddAdapter(context, mutableListOf(), R.layout.item_recent_add_user)
