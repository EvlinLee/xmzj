...
public class LiveTopicContract {
     ...
     * @see BaseUiView
     */
    public interface View extends BaseUserView<LiveTopicContract.Presenter> {
        /**
         * 展示数据
         *
         * @param datas
    ...
    public interface Source extends BaseSource {
        void getData(int start, String id, ApiCallBack<List<NewsBean>> callBack);
    }
}
