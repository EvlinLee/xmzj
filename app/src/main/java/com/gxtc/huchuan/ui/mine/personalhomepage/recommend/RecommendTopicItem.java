...
public class RecommendTopicItem implements ItemViewDelegate<PersonalHomeDataBean> {
    private Activity mContext = null;
    public RecommendTopicItem(Activity context) {
        mContext = context;
    }
    ...
    private static class MyrecyclerViewAdapter extends BaseRecyclerAdapter<HomePageChatInfo> {
        ...
        @Override
        public void bindData(BaseRecyclerAdapter.ViewHolder holder, int position, HomePageChatInfo chatInfoBean) {
