...
import com.gxtc.huchuan.adapter.UserRiseAdapter;
...
public class UserRiseFragment extends BaseTitleFragment implements UserContract.RiseView {
    ...
    private UserRiseAdapter adapter;
    ...
    public View initView(LayoutInflater inflater, ViewGroup container) {
        View view     = inflater.inflate(R.layout.fragment_user_rise, container, false);
        ...
        headView      = View.inflate(getContext(), R.layout.head_user_rise, null);
    ...
    public void initData() {
        ...
        adapter = new UserRiseAdapter(getContext(), new ArrayList<UserRiseDataBean>(), R.layout.item_user_rise);
...
//        lAxis.setGridDashedLine(new DashPathEffect(new float[]{5.0f,5.0f},0));      //设置网格虚线
    ...
    @Override
    public void setPresenter(UserContract.RisePresenter presenter) {
