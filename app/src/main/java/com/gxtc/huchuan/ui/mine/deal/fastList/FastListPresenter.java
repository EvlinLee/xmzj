...
public class FastListPresenter implements IssueListContract.Presenter{
    ...
    public FastListPresenter(IssueListContract.View mView) {
        this.mView = mView;
    ...
    public void getData(boolean isRefresh) {
        ...
        mData.getFastList(token, start+"",1, new ApiCallBack<List<PurchaseListBean>>() {
            @Override
