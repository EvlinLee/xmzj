...
public class RecommendNewsItem implements ItemViewDelegate<PersonalHomeDataBean> {
    private Activity mContext = null;
    public RecommendNewsItem(Activity context) {
        mContext = context;
    }
    ...
    private static class MyrecyclerViewAdapter extends BaseRecyclerAdapter<NewsBean> {
        ...
        @Override
        public void bindData(BaseRecyclerAdapter.ViewHolder holder, int position, NewsBean newsBean) {
