...
import com.gxtc.huchuan.adapter.RecentActiveAdapter
 ...
 * 活跃用户
 */
class ActiveUserFragment : BaseTitleFragment() {

    private var start = 0
    private var dateType = "0"       //2 最近30天
    private var checkType = "2"      //0 新增用户 1 新增动态 2 活跃量
    private var groupId: Int ?= null

    private lateinit var mData: CircleSource
    private lateinit var mAdapter: RecentActiveAdapter
    ...
    override fun initView(inflater: LayoutInflater?, container: ViewGroup?): View {
        ...
        mAdapter = RecentActiveAdapter(context, mutableListOf(), R.layout.item_list_recent_active)
