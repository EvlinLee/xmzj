...
import com.gxtc.huchuan.ui.mine.incomedetail.distribute.CircleProfitDetailActivity;
...
public class CircleProfitListFragment extends BaseTitleFragment implements DistributeContract.View,View.OnClickListener{
    ...
    private void initRecyclerView() {
        ...
        adapter.setOnClickClassBottomLayoutListenr(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DistributionBean bean = (DistributionBean) v.getTag();
                if("0".equals(bean.getIsDr())){
                    CircleProfitDetailActivity.jumpToIncomeInfoActivity(getActivity(),bean,dateType);
                }else {
                    ToastUtil.showShort(MyApplication.getInstance(),"该条数据已被删除，仅供浏览");
                }
            }
