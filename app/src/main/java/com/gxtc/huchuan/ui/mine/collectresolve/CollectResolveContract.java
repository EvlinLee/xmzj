...
public interface CollectResolveContract {

    int RESULTE = 101;
    int REQUEST = 100;

    interface View extends BaseUserView<CollectResolveContract.Presenter>{
    ...
    interface Presenter extends BasePresenter{
        ...
        void saveCollection(HashMap<String, String> map);
    ...
    interface Source extends BaseSource{
        ...
        void saveCollection(Map<String, String> map, ApiCallBack callBack);
    }
}
