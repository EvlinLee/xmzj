...
import com.gxtc.huchuan.ui.mine.personalhomepage.more.PersonalDealMoreActivity;
...
public class DealItemView implements ItemViewDelegate<PersonalHomeDataBean> {
    private Activity mContext = null;
    private String userCode;
    public DealItemView(Activity context,String userCode) {
        mContext = context;
        ...
        if (holder.getDataTag() == null) {
            ...
            holder.getView(R.id.tv_more).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    GotoUtil.goToActivity(mContext, PersonalDealMoreActivity.class,0,userCode);
                }
            });
    ...
    private static class MyrecyclerViewAdapter extends BaseRecyclerAdapter<DealListBean> {
        ...
        @Override
        public void bindData(ViewHolder holder, int position, DealListBean dealBean) {
