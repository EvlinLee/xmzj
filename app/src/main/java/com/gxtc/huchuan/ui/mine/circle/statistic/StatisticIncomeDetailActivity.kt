 ...
 */
class StatisticIncomeDetailActivity : BaseTitleActivity(),StatisticIncomeDetailContract.View {
    ...
    override fun initView() {
        ...
        baseHeadView.showTitle(circleName + "收益明细").showBackButton(object : View.OnClickListener {
    ...
    companion object {
        fun jumpToStatisticIncomeDetailActivity(activity: Activity, groupId: Int, timeSection: String?, count: Int?, income: Double?, dateName: String, circleName: String?){
            val intent = Intent(activity,StatisticIncomeDetailActivity::class.java)
